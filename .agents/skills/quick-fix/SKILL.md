...
Если пользователь уже вручную сделал такую правку, отдельный PROJECT QUICK FIX не нужен: `GIT CHECK`/`COMMIT` могут принять её как micro-change без STEP после проверки критериев.
