...
Почему у Claude Code есть нативный project-local settings layer, а у Codex пока нет его аналога, описано в [`docs/harness/AGENT_CONFIGURATION.md`](../docs/harness/AGENT_CONFIGURATION.md#локальные-настройки-runtime).
